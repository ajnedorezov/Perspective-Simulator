function Fig_5_9_through_5_12
    %% Generate the labyrinth
    I3 = maze(5, 5, 'c', 1);   % figure 5-1
    I1 = maze(5, 5, 'c', 3);   % figure 5-7
    I2 = maze(5, 5, 'c', 5);   % figure 5-8
    I4 = maze(5, 5, 'c', 4);   % figure 5-12

%     % I = maze(5, 5, 'c', n);
%     
%     [hfG1, hfS1] = performAlgo(I1);
%     saveas(hfG1, 'Thesis Images\Chapter 5\figure_5_9-ClockwiseRotation', 'png');
%     
%     [~, hfS2] = performAlgo(I2);
% 
%     saveas(hfS1, 'Thesis Images\Chapter 5\figure_5_10-LeftIm', 'png');
%     saveas(hfS2, 'Thesis Images\Chapter 5\figure_5_10-RightIm', 'png');
% 
% %     newFig = figure('Position', [25 502 1230 420]);
% %     ax1 = subplot(121);
% %     ax2 = subplot(122);
% %     
% %     copyobj(gca(hfS1), newFig);    
% %     copyobj(gca(hfS2), newFig);
%     
% %     saveas(newFig, 'Thesis Images\Chapter 5\figure_5_10-ClockwiseRotation', 'png');
% 
%     [~, hfS3] = performAlgo(I3);
%     saveas(hfS3, 'Thesis Images\Chapter 5\figure_5_11-Unchanged', 'png');
    
    [~, hfS4] = performAlgo(I4);
    saveas(hfS4, 'Thesis Images\Chapter 5\figure_5_12-StillHasFailure', 'png');
end

function [hfGradient, hfSolution] = performAlgo(I)
    %% Create the edge map
    sigma = 2;
    f = double(I > 0.5);
