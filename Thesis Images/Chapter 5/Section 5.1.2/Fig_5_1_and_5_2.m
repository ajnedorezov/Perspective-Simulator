...
hIm = imshow(f,[]);
hold on
title('Energy function with initial active contour')    
...
title('Energy function with active contour solution')   
saveas(gcf, 'Thesis Images\Chapter 5\figure_5_2-ShortcutThroughWall', 'png');