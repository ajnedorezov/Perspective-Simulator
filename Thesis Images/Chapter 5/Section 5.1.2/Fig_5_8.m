...
title('Gradients')
% axis([370 410 220 260])
% 
% saveas(gcf, 'Thesis Images\Chapter 5\figure_5_5-GradientsOnWall', 'png');
...
saveas(gcf, 'Thesis Images\Chapter 5\figure_5_8-WallSlopeGradientInsufficientIntersection', 'png');