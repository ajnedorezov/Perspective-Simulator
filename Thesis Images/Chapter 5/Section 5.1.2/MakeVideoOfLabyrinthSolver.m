function MakeVideoOfLabyrinthSolver
    %% Generate the labyrinth
%     I1 = maze(5, 5, 'c', 1);   % figure 5-1
    I2 = maze(5, 5, 'c', 3);   % figure 5-7
%     I3 = maze(5, 5, 'c', 5);   % figure 5-8
%     I4 = maze(5, 5, 'c', 4);   % figure 5-12
    
    [~, ~] = performAlgo(I1, true, false, 1000, 'Thesis Images\Chapter 5\Maze1.gif');
%     [~, ~] = performAlgo(I2, true, true, 2000, 'Thesis Images\Chapter 5\Maze3.gif');
    [~, ~] = performAlgo(I3, true, true, 600, 'Thesis Images\Chapter 5\Maze5.gif');
%     [~, ~] = performAlgo(I4, false, true, 2250, 'Thesis Images\Chapter 5\Maze4.gif');

    
end

function [hfGradient, hfSolution] = performAlgo(I, towardsGoal, clockwise, maxiter, fname)
    %% Create the edge map
    sigma = 2;
    f = double(I > 0.5);
