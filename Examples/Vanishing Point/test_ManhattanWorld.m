...
%             quiver(xpos, ypos, 10*sin(ang(1)), 10*cos(ang(1)), 'color', 'r', 'linewidth', 3);
%             quiver(xpos, ypos, 10*sin(ang(2)), 10*cos(ang(2)), 'color', 'g', 'linewidth', 3);
%             quiver(xpos, ypos, 10*sin(ang(3)), 10*cos(ang(3)), 'color', 'b', 'linewidth', 3);
