...
vid = VideoReader('Examples\CamSeqManipulation\SimulatedDataSet.avi');
vidGT = VideoReader('Examples\CamSeqManipulation\SimulatedDataSetGT.avi');
...
% save('Examples\CamSeqManipulation\Simulated_EdgeResults.mat', 'truePositive', 'falsePositive', 'trueNegative', 'falseNegative', 'sensitivity', 'specificity')
