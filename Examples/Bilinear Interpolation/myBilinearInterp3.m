...
% hp = plot(0,0,'go','MarkerSize', 10, 'MarkerFaceColor',[0 .5 0]);
% hl = plot(0,0,'m','LineWidth', 3);
...
%             set(hl, 'XData', tx([1:3 1]), 'YData', ty([1:3 1]), 'Color', 'm');
